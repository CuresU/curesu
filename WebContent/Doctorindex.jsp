 ...
 <%
 	...
 	if(session!=null)
 	{
 		if(session.getAttribute("d")!=null)
 		{
 			...
 			int dfees=Integer.parseInt(d.getFees());
 			System.out.println(dfees);
 			int income=count*dfees;
 			//int income=Integer.parseInt(d.getFees());
 			System.out.println("id is : " + d.getDid());
 			System.out.println("userindex2222222222222222222222");
 %>
    <section>
						...
						<ul>
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p><%=d.getFname() %><span>Doctor</span></p>
										 </div>
								...
								<ul class="dropdown-menu drp-mnu">
									...
									<li> <a href="Dlogout.jsp"><i class="fa fa-sign-out"></i> Logout</a> </li>
									<!-- <li> <a href="ADoctorNotification.jsp">All doctors</a></li>
