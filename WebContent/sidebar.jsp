...
<body class="sticky-header left-side-collapsed">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="Adminindex.jsp"> <span>Admin</span></a></h1>
			</div>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active">
							<a href="Alogout.jsp"><i class="lnr lnr-power-switch"></i>
							<span>Logout</span></a>
						</li>
						<li>
							<a href="ADoctorNotification.jsp"><i class="fas fa-user-md"></i>
								<span>Doctor Notifications</span></a>								
						</li>
						<li>
							<a href="Apatient_table.jsp"><i class="fas fa-user-md"></i>
							 <span>Patients</span></a>
						</li>
						<li>
							<a href="Adoctor_table.jsp"><i class="fas fa-user-md"></i>
						 	<span>Doctors</span></a>
						 </li>              
						<li>
							<a href="Appointment_table.jsp"><i class="lnr lnr-envelope"></i>
							<span>Appointments</span></a>
						</li>							
						<li>
							<a href="Feedback.jsp"><i class="lnr lnr-pencil"></i>
