...
<head>
    <title>Replenish HR Management Category Bootstrap responsive Web Template | Employer list:: w3layouts</title>
                        ...
                        <div class="emply-resume-list row mb-3" style="height:500px; width: 1100px;">
                            <div class="col-md-9 emply-info">
                                <div class="emply-img">
                                    ...
                                    <img src="imagesuser/<%=d.getC_image() %>" alt="" class="img-fluid" style="margin-top:50px;">
                                </div>
                                <div class="emply-resume-info">
