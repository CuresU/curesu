...
<%
	...
	{ */
		...
		/* String otps=request.getAttribute("otps").toString(); */
		String id=Integer.toString(u.getUid());
	/* } */
		System.out.println("in forgototp.jsp");
...
-->								<div class="clearfix"> </div>
							...
							<div class="log-input">
 							...
 							<table>
 							<tr colspan="2">
								<td><input type="submit" name="action" value="Submit OTP" style="margin-left:40px; width:150px;"></td>
								<td><input type="submit" name="action" value="Resend OTP" style="margin-left:40px; width:150px;"></td>
							</tr>
							</table>
						</form>	 
						</div>
